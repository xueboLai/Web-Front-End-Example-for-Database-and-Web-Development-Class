...
while(!feof($open_file)){
	...
	print("<td>");
	if($i==3){
		print("<img src = 'pics/$info[$i]' height=250 width=250 >");
	}else{
		print($info[$i]);
	}
	print("</td>");
...
?>
	<br>
	<br>	
	<a href = "product1.php" style = "font-size:24px; color:brown;">Click here to see the php source code for product.php</a>
